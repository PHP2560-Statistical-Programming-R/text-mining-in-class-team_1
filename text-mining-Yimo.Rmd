...
#2. Text Analysis
##2.1 Q1: who is the most important charecter based on how often he/she was mentioned ?
```{r}
...
##2.2 Q2: What's the difference between the frequency of the name "Ron" and "Hermione" through chapters
```{r}
...
##2.3 Q3. what the top ten used words in exception to stop words ?
```{r}  
...
##3.1 what is the most scariest book based on sentiment analysis ?
```{r}
#Load nrc
...
##3.2 Q2.The frequency of emotions
```{r}  
#Select out positive and negative
...
ggplot(harry_sentiment, aes(reorder(sentiment, n), n, fill = sentiment))+
    ...
    theme(axis.title.x=element_blank(),
        axis.text.x=element_blank())+
  labs(y = "Frequency")+
  ggtitle("The Frequency of Words Related to Different Emotions")+
...
##3.4 Q4. How does sentiment change through chapter.
```{r}
#Load afinn
...
ggplot(sentiment_by_popularity)+
  ...
  coord_flip()+
  plot_theme+
  theme(legend.position = c("right"), legend)
