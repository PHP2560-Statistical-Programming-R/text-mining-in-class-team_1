...
bookMetadata$Title  = bookMetadata$Title%>%
  str_to_lower()%>%
  str_replace_all(pattern = or(harry_potter, "'", ":children's edition"), "")%>%
  str_replace_all(pattern = or(" ", "-"), "_")
...
bookMetadata = bookMetadata%>%
  mutate(year = str_match(bookMetadata$Publication.Date, pattern = date_pattern)[,4])

dates2 <- c("20jan07","06sep01","6august05","6august2005","20june1999") 
