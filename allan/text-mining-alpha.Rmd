...
Harry Potter being my favourite novel and one of the most popular novel, I decided to do some basic yet informative frequency & sentimental analysis
...
I had to extract other metadata like  publisher, ranking, sales, author e.t.c from https://www.theguardian.com/us

I got my hands dirty by doing some basic web scraping on https://en.wikipedia.org to extract character details.
