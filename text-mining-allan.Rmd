...
1. what is the most important charecter based on how much it was mentioned 
```{r  message=FALSE, warning=FALSE}
...
1. How does positive sentiment change over time, Does the author has a specific pattern of control of positive sentiment?
```{r  message=FALSE, warning=FALSE}
...
2. How does negative sentiments changes over time? Is there any similarities in the 1st and last chapter?
```{r  message=FALSE, warning=FALSE}
...
4. How frequently did  the top 8 most popular characters appear in the last Book
```{r  message=FALSE, warning=FALSE}
...
```
7. What are the top 6 topics discussed in harry potter
...
```
7. How Does the 6 topics discussed varry from each series of Harry Potter
```{r message=FALSE, warning=FALSE}
