...
# download harry potter wikipedia page
 ...
 custom_stop_words <-  c('Wikipedia','Wikimedia','The','')
# read entire hp_wikipedia_site
 hp_characters <- str_match( hp_wikipedia_site, capture (UPPER %R% one_or_more(WRD)) %R% SPC %R% capture(UPPER %R% one_or_more(WRD))) %>%
